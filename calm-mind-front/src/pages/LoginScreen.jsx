...
export default function LoginScreen() {
  ...
  return (
    <div className="fixed inset-0 flex w-full overflow-hidden">
      <div className="w-full lg:w-1/2 bg-white p-8 flex items-center justify-center min-h-0">
        ...
        <div className="w-full max-w-md max-h-full overflow-auto text-left">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              {/* If you want label text to align with the input's inner text, add pl-3 */}
      ...
      <div className="hidden lg:block lg:w-1/2 min-h-0">
